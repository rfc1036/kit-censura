...
################ Download Attachment ###############
def download(imap, email_from, path, file_name, file_name_crypt ):
    try:
        ...
        for msgId in data[0].split():
            ...
            for part in mail.walk():
                ...
                if bool(fileName) and file_name in fileName:
...
download(
    imap, 
    attachment_config['EMAIL_FROM'], 
    path, 
    attachment_config['FILE_NAME'], 
